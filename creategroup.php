         ...
         <div class="box">
          ...
          $permission = $row["permission"];
            $msg="<div class='box'>
                ...
                <button class='grp-buttons' id='create-family-btn'>Create new family</button>
                  <br><br>
                  <div id='join-family-form'>
                      ...
                      <h3>New Family Calendar:</h3>
                       <button id='authorize-button'>Log in</button><br><br>

                         <label>Choose a nickname for your family:<br>
