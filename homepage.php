...
<div class="dropdown pull-right" style='margin-top:6px'>
  <button class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" data-hover="dropdown">
   <div id="welcome-user"></div> <span class="caret"></span>
  </button> <?php echo "<form action='logout.php' method='post'><input type='submit' value='Logout'>
</button></form>";
  ?>
  <ul class="dropdown-menu">
    <li><a href="#"><img src="http://pluspng.com/img-png/user-png-icon-male-user-icon-512.png" style='width:20px'>   My Profile</a></li>
    ...
    <?php
        ...
        if(!isset($_SESSION['user'])){
          ...
          exit;
            ...
            <script> console.log('password match'); 
            $(document).ready(function(){
            document.getElementById('welcome-user').innerHTML ='<h1><span>".$_SESSION['user']."</span></h1>';
            });
            </script>
        ";       
        }  
      ...
      <div class="container">
        <div class="row" dir="rtl">
            ...
            <a href="shoppinglist.php">
              ...
              <ul dir='ltr' class='col-details'>
                <li>Grocery List</li>
                <li style='font-size: 18px'>Food Recipes Search</li>
              </ul>
            </div>
            </a>
            <a href="gifts.php">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="updates col-lg-4">
              <h3>Latest Done Chores</h3>              
...
<h4><b> ".$row['c_title']."</b></h4><h4>".$row['c_score']."<img src='img/coin.png' style='display:inline-block;vertical-align:bottom;width:30px;height:30px;'></h4><h4>".$newDate."  <span class='glyphicon glyphicon-calendar'></span></h4>
</div>";
